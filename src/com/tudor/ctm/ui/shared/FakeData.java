...
public class FakeData {
		...
		public static List<CloudProject> getCloudProjects() {
			...
			return Arrays.asList(
					new CloudProject.Builder().id((long) 1).name("Cloud Project 1").owner(new UserData("ttabacel@gmail.com", "LogoutURL", false)).build(),
					new CloudProject.Builder().id((long) 2).name("Cloud Project 2").owner(new UserData("ttabacel@gmail.com", "LogoutURL", false)).build()
					);
		}
